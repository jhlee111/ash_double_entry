...
defmodule AshDoubleEntry.Balance.Changes.AdjustBalance do
  @moduledoc false
  # No longer used by the library: a Transfer ripples through
  # `:shift_balances_after`, one account at a time, the way entries do. Kept
  # because Balance resources generated by earlier installers define an
  # `:adjust_balance` action of their own that references this change.
